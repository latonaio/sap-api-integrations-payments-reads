...
import (
	...
	"io/ioutil"
	"net/http"
	sap_api_output_formatter "sap-api-integrations-payments-reads/SAP_API_Output_Formatter"
	"strings"
	"sync"
...
func (c *SAPAPICaller) PaymentCollection(iD string) {
	paymentCollectionData, err := c.callPaymentsSrvAPIRequirementPaymentCollection("PaymentCollection", iD)
	if err != nil {
		c.log.Error(err)
		return
	}
